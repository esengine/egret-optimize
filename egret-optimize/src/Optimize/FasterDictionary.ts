    ...
    export class FasterDictionary<TKey, TValue> {
        ...
        public addValue(key: TKey, value: TValue, indexSet: {value: number}) {
            ...
            if (valueIndex == -1) {
                ...
                this._valuesInfo[this._freeValueCellIndex] = new Node(key, hash);
            } else {
                {
                ...
                this._valuesInfo[this._freeValueCellIndex] = new Node(key, hash, valueIndex);
        ...
        public static updateLinkedList(index: number, valuesInfo: Node[]){
